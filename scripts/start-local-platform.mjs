...
const services = [
  ...
  },
  {
    name: "travel-service",
    command: "java",
    args: ["-jar", join(root, "services", "travel-ticket", "target", "travel-ticket-service-0.1.0-SNAPSHOT.jar")],
    cwd: join(root, "services", "travel-ticket"),
    env: {
      SERVER_PORT: "8090",
      DB_URL: "jdbc:postgresql://127.0.0.1:5432/platform_travel",
      DB_USERNAME: "platform",
      DB_PASSWORD: process.env.POSTGRES_PASSWORD || "platform",
      REDIS_HOST: "127.0.0.1",
      REDIS_DATABASE: "2",
